...
class Page:
    ...
    def __str__(self) -> str:
        return f"{self.__class__.__name__}(title={self._title}, path={self._path}, properties={self._properties}, children={len(self.get_children()) if self.get_children() else 0})"